  ...
  function printStories(data) {
    ...
    $(storyDivs).each(function(index) {
      ...
      $(categories[index]).each(function() {
        $(storyHashId+" .categories").append("<div class='col-sm-6'><div class='category'>"+this+"</div></div>");
